...
const getProfilePictureUrls = (picture) => (0, lodash_1.map)(picture === null || picture === void 0 ? void 0 : picture.artifacts, artifact => `${picture === null || picture === void 0 ? void 0 : picture.rootUrl}${artifact.fileIdentifyingUrlPathSegment}`);
...
class ProfileRepository {
    ...
    async getProfile({ publicIdentifier }) {
        ...
        const companies = results.filter(r => r.$type === linkedin_company_entity_1.COMPANY_TYPE);
